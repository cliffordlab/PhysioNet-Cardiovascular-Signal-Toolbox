function [ RR_gapFilled, t_gapFilled] = RR_Preprocessing_for_MSE( rr, t )
%
% [ RR_gapFilled, t_gapFilled] = RRIntervalPreprocess(rr,t);
% This function deals with missing data in rr time series. When rr
% intervals is 'too' long, i.e., grather that 2 times the median value of
% the 10 rr inetrvals before and after, this function will fill the gap
% with median values
%
