...
% varibles:
% up.paramSet.winLeng lenght of wndows for respiration signal estimate
% wins.t_start: starting point of each window
% latest_start: first started point of first window - name is due to we are using 3 different estimates (am,bw, and fs) and we use the latest start of the first start point from 3 different estimates.
% gap_between_win_starts: amount of overlap depending on the analysis, and it will depend on up.paramSet.winStep
...
%% Define windows
duration_of_one_win = up.paramSet.winLeng; % In seconds
