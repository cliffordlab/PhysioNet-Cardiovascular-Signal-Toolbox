...
up.paths.root_folder = '$INPUTFOLDER';%'C:\Documents\Data\';
...
up.al.options.extract_resp_sig = {'ekg_feat'};
% ------------------------------------------------------
...
up.al.options.estimate_rr = {'CtO'};%{'FTS', 'CtO', 'ZeX'};       % Possible methods: 'FTS', 'ARS', 'ARM', 'ARP', 'ARPz', 'ACF', 'WCH', 'PKS', 'ZeX', 'PZX', 'CtO', 'CtA'
...
data_path = [up.paths.data_load_folder, up.paths.data_load_filename, '.mat']; % File RRSYNTH file
