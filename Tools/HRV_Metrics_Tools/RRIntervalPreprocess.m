function [NNinterp3, tinterp3, flagged_beats] = RRIntervalPreprocess(rr,time,annotations,sqi,HRVparams)
%
%   [NNinterp3, tinterp3, flagged_beats] = RRIntervalPreprocess(rr, time, annotations, sqi, HRVparams)
%
...
%
%   OUTPUT:     NNinterp3     - normal normal interval data
%               NNinterp3     - time indices of NN data
