function [beat] = wabp_pleth_new(data,from,to)
...
% output:   beat: position of PPG beats
...
LPERIOD  = 1000;        % /* learning period is the first LPERIOD samples */
...
while t <= to
	...
	if (temp > T1)    % /* found a possible ABP pulse near t */ 
        ...
        if max>min+10
            ...
            for tt=tt:-1:t - EyeClosing / 2 +3
                temp2=slpsamp(tt,data);
                temp3=slpsamp(tt-3,data);
